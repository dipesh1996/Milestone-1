...
public class OrQueryTest {
    ...
    /**
     * Test of getPostings method, of class OrQuery.
     */
    @Test
    public void testGetPostings() throws IOException {
        System.out.println("Or Query Test Case I Complete");
    ...
    public void testGetPostingsTwo() throws IOException {
        System.out.println("Or Query Test Case II Complete");
        DocumentCorpus corpus = DirectoryCorpus.loadJsonDirectory(Paths.get("C:\\Users\\dipes\\Desktop\\Unit Test\\JSON").toAbsolutePath(), ".json");
        String query = "json + text";
        Index[] index = indexCorpus(corpus);
    ...
    public void testGetPostingsThree() throws IOException {
        System.out.println("Or Query Test Case III Complete");
        DocumentCorpus corpus = DirectoryCorpus.loadJsonDirectory(Paths.get("C:\\Users\\dipes\\Desktop\\Unit Test\\JSON").toAbsolutePath(), ".json");
        String query = "UNIT + \"256.256.256.256\"";
        Index[] index = indexCorpus(corpus);
