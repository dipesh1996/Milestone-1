...
/**
 * A DirectoryCorpus represents a corpus found in a single directory on a local
 * file system.
 */
public class DirectoryCorpus implements DocumentCorpus {
    ...
    /**
     * Constructs a corpus over an absolute directory path. Before calling
     * GetDocuments(), you must register a FileDocumentFactory with the
     * RegisterFileDocumentFactory method. Otherwise, the corpus will not know
     * what to do with the files it finds. The LoadTextDirectory facade method
     * can simplify this initialization.
     *
     * @see
     */
    ...
    /**
     * Constructs a corpus over an absolute directory path, only loading files
     * whose file names satisfy the given predicate filter.
     */
    ...
    /**
     * Finds all file names that match the corpus filter predicate and have a
     ...
     *
     * @param fileExtension The extension of the JSON documents to load, e.g.,
     * ".json".
     */
